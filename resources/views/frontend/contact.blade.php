...
@section('content')
    ...
    <section id="main-container" class="main-container">
      <div class="container">
        ...
        <div class="row">
          <div class="col-md-12">
            <h2 class="section-title text-center mt-5">We are eager to hear your suggestions and complaints</h2>
            <h3 class="section-sub-title text-center">Get in touch with us</h3>
