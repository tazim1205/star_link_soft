        ...
        <div class="container">
            <div class="row justify-content-between">
                <div class="col-lg-4 col-md-6 footer-widget footer-about">
                    ...
                    <img loading="lazy" class="footer-logo" src="{{ asset('frontend') }}/images/Logo-For-Share.gif" alt="Constra">
                    <p>Empowering Businesses With Intelligent Software Solutions</p>
                    ...
                    <div class="col-lg-3 col-md-6 mt-5 mt-lg-0 footer-widget">
                        ...
                        <ul class="list-arrow">
                            <li><a href="service-single.html">E-Commerce Website</a></li>
                            <li><a href="service-single.html">Online News Portal</a></li>
                            <li><a href="service-single.html">Inventory Software</a></li>
                            <li><a href="service-single.html">Education Management</a></li>
                            <li><a href="service-single.html">Android Apps Development</a></li>
                        </ul>
                    </div><!-- Col end -->
                    <div class="col-lg-3 col-md-6 mt-5 mt-lg-0 footer-widget">
                        <h3 class="widget-title"></h3>
                        <ul class="list-arrow">
                            <li><a href="service-single.html">POS System Software</a></li>
                            <li><a href="service-single.html">ERP Software</a></li>
                            <li><a href="service-single.html">Pharmacy Software</a></li>
                            <li><a href="service-single.html">Multipurpose Software</a></li>
                            <li><a href="service-single.html">courier Management</a></li>
                        </ul>
                    </div><!-- Col end -->
                </div><!-- Row end -->
            </div><!-- Container end -->
                    ...
                    <div class="col-md-12">
                        <div class="copyright-info text-center">
                            <span>Copyright &copy; <script>
                                ...
                                </script>, &amp; Developed by <a href="#">Star Link Soft</a></span>
                                </div>
                            </div>
                            <!-- <div class="col-md-12">
                                <div class="copyright-info text-center">
